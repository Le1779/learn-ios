...
class LearnBLEViewControllerOLD: UIViewController {
...
extension LearnBLEViewControllerOLD :UITableViewDelegate,UITableViewDataSource{
...
extension LearnBLEViewControllerOLD :CBCentralManagerDelegate{
